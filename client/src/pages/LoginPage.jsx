    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-blue-50 to-emerald-50">
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 card bg-blue-50/50 border-blue-100">
          <h3 className="font-medium text-sm text-gray-700 mb-2">משתמשים לבדיקה (פיתוח)</h3>
          <div className="text-xs text-gray-600 space-y-1">
            <div><code className="bg-white px-1.5 py-0.5 rounded">admin</code> - מנהל מערכת</div>
            <div><code className="bg-white px-1.5 py-0.5 rounded">warehouse</code> - מנהל מחסן</div>
            <div><code className="bg-white px-1.5 py-0.5 rounded">tlv</code> - סניף תל אביב</div>
            <div><code className="bg-white px-1.5 py-0.5 rounded">jlm</code> - סניף ירושלים</div>
            <div className="pt-1 text-gray-500">סיסמה לכולם: <code className="bg-white px-1.5 py-0.5 rounded">password123</code></div>
          </div>
        </div>
      </div>
    </div>
